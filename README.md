# Editor Guidelines 🌺
A Visual Studio extension that adds vertical column guides to the text editor, without telemetry.
...
You can download the extension (VSIX) from the Releases page and manually install it.
